...
def create_summary_markdown(
    ...
    with open(md_file_path, mode, encoding="utf-8") as file:
        ...
        if regenerate:
            ...
            file.write(
                "| Certificate ID | Certificate Holder ID | Holder Name | Certificate Name | Level | Certified at | Valid Until | Contacts |\n"
            )
            file.write("| --- | --- | --- | --- | --- | --- | --- | --- | --- |\n")
        ...
        for data in certificate_data:
            file.write(
                f"| {data['certificate_id']} | {data['certificate_holder_id']} | {data['user_name']}{data['last_name']} | {data['certificate_name']} | {data['certified_at']} | {data['valid_until']} |  {data['contact']} |\n"
            )
